...
export default function Sidebar() {
  ...
  return (
    <div
      className={`${poppins.variable} w-[260px] h-screen bg-gradient-to-b from-[#F9F9FF] to-white fixed left-0 top-0 border-r border-[#E2E8F0] flex flex-col shadow-lg`}
    >
          ...
          return (
            <Link
              ...
              className={`flex items-center px-5 py-3 rounded-lg text-[14px] hover:bg-[#E6E8F5] transition-all duration-200 relative
                ${
                  pathname === item.link
                    ? "text-[#007BFF] bg-[#E6E8F5] font-semibold"
                    : "text-[#64748B] hover:text-[#007BFF]"
                }`}
            >
              {pathname === item.link && (
